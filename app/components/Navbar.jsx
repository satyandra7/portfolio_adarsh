    ...
    dark:hidden'>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
       flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
            <Image src={isDarkMode ? assets.logo_dark : assets.logo}  className='w-28 alt=" "
        ...
        <div className='flex items-center gap-4'>
            ...
            px-10 py-2.5 border-gray-500 rounded-full ml-4 font-Ovo
            dark: border dark:border-white/50'> Contact 
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkTheme dark:text-white'> 
